...
class HandleFileUpload implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        foreach (preg_split("/((\r?\n)|(\r\n?))/", $content) as $line) {
            ...
            if (count($row) > 1) {
                ...
                try {
                    $this->insertProduct($productData, $ignore_errors);
                } catch (\Exception $e) {
     ...
     */
    private function insertProduct(array $productData, bool $ignore_errors = false)
    {
